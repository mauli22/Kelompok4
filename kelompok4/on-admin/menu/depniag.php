...
<div class="container">
		...
		<center>
			<h4>Departemen Perniagaan</h4>
			<h6>Hasil Penilaian Responden Pada Departemen Perniagaan</h6>
		</center>
		<br/><br/>
		...
		<!-- Button trigger modal -->
			...
			<div class="modal-dialog modal-xl modal-dialog-centered" role="document">
				...
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalCenterTitle">Grafik Departemen Perniagaan</h5>
