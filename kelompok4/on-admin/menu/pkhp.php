...
<!-- <div class="home-wrapper">
 -->
	<!-- <div class="col-md-10 col-md-offset-1 text-center">
		...
		<center>
			<h4>Biro Perencanaan Kemahasiswaan Humas dan Protokol</h4>
			<h6>Hasil Penilaian Responden Pada Biro Perencanaan Kemahasiswaan Humas dan Protokol</h6>
		</center>
		<br/><br/>
		...
		<!-- Button trigger modal -->
			...
			<div class="modal-dialog modal-xl modal-dialog-centered" role="document">
				...
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalCenterTitle">Grafik Biro PKHP</h5>
