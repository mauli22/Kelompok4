...
<div class="container">
		...
		<center>
			<h4>Departemen Sosial dan Lingkungan</h4>
			<h6>Hasil Penilaian Responden Pada Departemen Sosial dan Lingkungan</h6>
		</center>
		<br/><br/>
		...
		<!-- Button trigger modal -->
			...
			<div class="modal-dialog modal-xl modal-dialog-centered" role="document">
				...
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalCenterTitle">Grafik Departemen Sosial dan Lingkungan</h5>
				...
				<div class="modal-body">
					...
					<script>
						...
						options:{
							title:{
							display:true,
							text:'Departemen Sosial dan Lingkungan',
							fontSize:14
							},
							legend:{
							display:true,
