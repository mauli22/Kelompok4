...
<html lang="en">
  ...
  <body>
	...
	<div class="container">
		...
		<center>
			<h4><b>Departemen Riset Pengembangan Teknologi</b></h4>
			<h6>Hasil Penilaian Responden Pada Departemen Riset Pengembangan Teknologi</h6>
		</center>
		<br/>
		...
		<!-- Button trigger modal -->
			...
			<div class="modal-dialog modal-xl modal-dialog-centered" role="document">
				...
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalCenterTitle">Grafik Departemen Riset Pengembangan Teknologi</h5>
				...
				<div class="modal-body">
					...
					<script>
						...
						options:{
							title:{
							display:true,
							text:'Departemen Riset Pengembangan Teknologi',
							fontSize:14
							},
							legend:{
							display:true,
