...
<html lang="en">
  ...
  <body>
	...
	<div class="container">
		...
		<center>
			<h4><b>Departemen Olahraga</b></h4>
			<h6>Hasil Penilaian Responden Pada Departemen Olahraga</h6>
		</center>
		<br/>
		...
		<!-- Button trigger modal -->
			...
			<div class="modal-dialog modal-xl modal-dialog-centered" role="document">
				...
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalCenterTitle">Grafik Departemen Olahraga</h5>
